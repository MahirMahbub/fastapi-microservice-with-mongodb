...
from auth_management.schemas.user import UserRead, UserCreate, UserUpdate, UserReadVerify
from auth_management.utils.auth_manager import fastapi_users, auth_backend
